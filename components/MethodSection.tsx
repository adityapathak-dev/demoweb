...
const STEP_COLORS = ["#2f6bff", "#3ee2ff", "#b6f34a", "#ff7a59"];
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-24 sm:px-8 sm:py-32 lg:grid-cols-2 lg:items-center">
        <div>
          <SectionHeading
            ...
            title={
              <>
                How we <span className="text-gradient-brand">teach.</span>
              </>
            }
            ...
            {METHOD_STEPS.map((step, i) => (
              <Reveal as="li" key={step.index} delay={i * 60}>
                <div className="flex gap-5">
                  <span
                    className="mt-1 grid h-11 w-11 shrink-0 place-items-center rounded-full font-display text-xs font-bold text-white"
        ...
        <Reveal delay={150} className="relative">
          <div className="glass grain relative overflow-hidden rounded-[2rem] p-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 px-3 pb-3 pt-1">
              <p className="text-xs tracking-[0.2em] text-faint uppercase">
